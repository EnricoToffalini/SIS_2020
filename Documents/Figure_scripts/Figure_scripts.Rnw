...
\section{Plot prior}
<<Plot_prior, fig.pos="!ht", fig.align="center", fig.height=2.5, fig.width=5.5, fig.cap="", fig.scap="">>=
plot_prior()
...
plot_boxplots_all(res=res, method_labels = c("ML", "Bayesian default", "Reasonable priro","Experts prior"),

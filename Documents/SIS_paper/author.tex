...
To evaluate the influence of different prior specifications in the case of structural equation models with small sample size, we considered a mediation model from (\ldots). The study evaluated the relationship between participants' self-reported sleep quality, personality characteristics, and metacognitive beliefs about sleeping problems. In particular, the study found that there was no evidence of participants' tendency to experience distress and become anxious (\emph{Neuroticism}) being directly associated with self-reported sleep quality (\emph{Sleep quality}),  bu its role was mediated by how participants tend to interpret and control their thoughts about sleeping difficulties (\emph{Metacognitive thoughts}; see Fig.~\ref{}). In other words, people with high levels of distress and anxiety tend to have dysfunctional beliefs and attitudes about sleep that, in turns, induce them to perceive and report a worse-quality sleep.
